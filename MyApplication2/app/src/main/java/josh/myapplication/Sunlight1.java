...
public class Sunlight1 {
    ...
    //https://congress.api.sunlightfoundation.com/legislators?chamber=house&apikey=52bf01e9cad0422c8e3c1faa809ad959&per_page=all"
    ...
    public static String url(String queryString, String endString) {
        ...
        return BASE_URL +  queryString + "?chamber=house&apikey=" + apiKey +"&" + endString ;
    }
