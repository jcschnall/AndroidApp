...
public class AndroidListAdapterC extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<ResultsC> mPosts;
    private ViewHolder mViewHolder;

    private Bitmap mBitmap;
    private ResultsC mPost;
    private Activity mActivity;

    public AndroidListAdapterC(Activity activity, List<ResultsC> posts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // if (mPost.getBioguideId() != null) {
        ...
        mViewHolder.author.setText(mPost.getCommitteeId());
        mViewHolder.title.setText((String)mPost.getName());
        mViewHolder.date.setText(mPost.getChamber());
